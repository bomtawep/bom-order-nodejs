...
const updateImagePool = (request: any, response: any) => {
    ...
    if(path == null || path == ""){
        ...
        conPool.query('UPDATE bomorder.image SET filename = $1, originalname =  $2, filepath = $3, mimetype = $4, size = $5, updated = $6 where id = $7',
