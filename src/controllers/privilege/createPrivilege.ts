...
const createPrivilegePool = (request: any, response: any) => {
    ...
    if((name == null || name == "") && (pri_num == null || pri_num == "")){
        ...
        conPool.query('INSERT INTO bomorder.privilege (name, pri_num, created, updated) VALUES ($1, $2, $3, $3)', 
        [name, pri_num, sysDate], (error: any, results: any) => {
            if (error) {
                throw error
            }
