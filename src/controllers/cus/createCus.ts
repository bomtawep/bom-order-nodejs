...
const createCusPool = (request: any, response: any) => {
    ...
    if(pri_id == null || pri_id == "" || acc_id == null || acc_id == "" || fname == null || fname == "" || lname == null || lname == "") {
        ...
        conPool.query('INSERT INTO bomorder.customer (pri_id, acc_id, fname, lname, gender, birthdate, regisdate, created, updated) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $8)', 
        [pri_id, acc_id, fname, lname, gender, birthdate, regisdate, sysDate], 
