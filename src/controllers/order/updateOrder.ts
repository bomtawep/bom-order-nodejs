...
const updateOrderPool = (request: any, response: any) => {
    ...
    if(p_id == null || p_id == "" || emp_id == null || emp_id == "" || cus_id == null || cus_id == "" || table_id == null || table_id == ""){
        ...
        conPool.query('UPDATE bomorder.order SET p_id = $1, emp_id =  $2, cus_id = $3, table_id = $4, updated = $5 where id = $6',
            [p_id, emp_id, cus_id, table_id, sysDate, id], (error: any, results: any) => {
                if (error) { 
                    throw error
                }
