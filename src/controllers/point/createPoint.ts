...
const createPointPool = (request: any, response: any) => {
    ...
    if((username == null || username == "") && (password == null || password == "")){
        ...
        conPool.query('INSERT INTO bomorder.privilege (username, password) VALUES ($1, $2)', [username, password], (error: any, results: any) => {
            if (error) {
                throw error
            }
