...
const createEmpImagePool = (request: any, response: any) => {
    ...
    if(path == null || path == ""){
        ...
        conPool.query('INSERT INTO bomorder.emp_image (filename, originalname, filepath, mimetype, size, created, updated) VALUES ($1, $2, $3, $4, $5, $6, $6)',
