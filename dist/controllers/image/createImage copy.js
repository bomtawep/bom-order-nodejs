...
const createImagePool = (request, response) => {
    ...
    if (path == null || path == "") {
        ...
        conPool.query('INSERT INTO bomorder.image_files (filename, originalname, filepath, mimetype, size, created, updated) VALUES ($1, $2, $3, $4, $5, $6, $6)', [filename, originalname, path, mimetype, size, sysDate], (error, results) => {
            if (error) {
                throw error;
            }
